 ...
 * @since 1.0.0
 */
public final class DefaultAgentToolCallingManager implements AgentToolCallingManager{

    private static final Logger logger = LoggerFactory.getLogger(DefaultAgentToolCallingManager.class);
    ...
    public DefaultAgentToolCallingManager(ObservationRegistry observationRegistry, ToolCallbackResolver toolCallbackResolver,
    ...
    public ToolExecutionResult executeToolCalls(Prompt prompt, ChatResponse chatResponse) {
        ...
        return executeToolCalls(prompt, chatResponse, toolName ->{}, (toolName,result) ->{}, (toolName,ex) ->{});
    }
    ...
    public ToolExecutionResult executeToolCalls(Prompt prompt, ChatResponse chatResponse,
        ...
        InternalToolExecutionResult internalToolExecutionResult = executeToolCall(prompt, assistantMessage,
                toolContext, pre, after, exception);
            ...
            String toolCallResult = ToolCallingObservationDocumentation.TOOL_CALL
                    ...
                    .observe(() -> {
                        ...
                        try {
                            ...
                            after.accept(toolName, toolResult);
                        }
                        catch (ToolExecutionException ex) {
                            toolResult = this.toolExecutionExceptionProcessor.process(ex);
                            exception.accept(toolName, ex);
                        }
    ...
    public final static class Builder {
        ...
        public DefaultAgentToolCallingManager build() {
            return new DefaultAgentToolCallingManager(this.observationRegistry, this.toolCallbackResolver,
